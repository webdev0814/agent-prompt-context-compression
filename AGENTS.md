...
- `[afefea5]` (2026-09-08) docs: update agent briefing with multi-computer handoff protocol
- `[31c1b81]` (2026-09-08) docs: update agent briefing with multi-computer handoff protocol
