...
- `[52ae4ea]` (2026-09-09) docs: update agent briefing with multi-computer handoff protocol
- `[f3de3b9]` (2026-09-09) docs: update agent briefing with multi-computer handoff protocol
